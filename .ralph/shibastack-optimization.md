...
- **Backlog (next iterations):** USB attach honesty (simulated per matrix); live stats in container LIST; image build (`container build`) UI; per-container restart/stop-all polish.
